...
public class ChatClientService {
    ...
    public String chat() throws OllamaBaseException, IOException, InterruptedException {
        return chat("Recite a haiku about recursion.");
    }

    public String chat(String userPrompt) throws OllamaBaseException, IOException, InterruptedException {
        String model = "tinyllama";

        PromptBuilder promptBuilder = new PromptBuilder()
                .addLine("You are a knowledgeable baseball expert.")
                .addLine("Answer questions about baseball players, history, and statistics.")
                .addLine("Be concise and helpful.")
                .addSeparator()
                .addLine(userPrompt);
